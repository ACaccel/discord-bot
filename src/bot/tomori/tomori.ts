...
// sync). It adds no fields beyond the base `Config` except an optional
// `social_link_preview` block, which the plugin parses and defaults in
// code. Channel suppression for guild-events / social-link-preview /
